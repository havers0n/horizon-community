...
console.log('🚀 Начинаем сборку MDT для FiveM NUI...');
...
try {
  ...
  // 2. Собираем MDT клиент для NUI
  console.log('📦 Собираем MDT клиент для NUI...');
  ...
  // 3. Создаём папку UI если её нет
  fs.ensureDirSync(fivemUIPath);

  // 4. Копируем собранные файлы в FiveM ресурс
  console.log('📋 Копируем файлы в FiveM ресурс...');
  fs.copySync(distPath, fivemUIPath);

  // 5. Копируем fivem-nui.js если его нет
  ...
  console.log('✅ Сборка MDT для FiveM NUI завершена успешно!');
