...
export function createTestRoutes(storage: IStorage, businessLogic: BusinessLogic): import('express').Router {
   ...
   */
  router.get('/application/:applicationId', authenticateToken, async (req: Request, res: Response) => {
    try {
