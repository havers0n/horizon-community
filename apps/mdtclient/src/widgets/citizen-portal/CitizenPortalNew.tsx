...
interface CitizenPortalNewProps {
  ...
  onViewChange: (view: CitizenView) => void;
}

const CitizenDashboard: React.FC<{ onAction: (action: CitizenView) => void }> = ({ onAction }) => {
  const { t } = useLocale();
...
export const CitizenPortalNew: React.FC<CitizenPortalNewProps> = ({ activeView, onViewChange }) => {
  ...
  const handleDashboardAction = (action: CitizenView) => {
    onViewChange(action);
  };
          ...
          <Card>
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-secondary-400">
                Функция управления питомцами находится в разработке
              </p>
            </div>
          </Card>
        );
        ...
        return (
          <Card>
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-secondary-400">
                Функция просмотра кодексов находится в разработке
              </p>
            </div>
          </Card>
        );
