...
export function MemberDashboard({ user, activities, announcements }: MemberDashboardProps) {
  return (
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-4">
              <Avatar className="h-16 w-16">
                <AvatarImage src={user.profileImageUrl || user.avatarUrl || undefined} alt="Профиль" />
            ...
            <div className="text-right">
              <div className="space-y-2">
                ...
                <div className="text-xs text-gray-500">
                  <p>
                    Игровые предупреждения:{" "}
                    <span className={`font-medium ${(user.gameWarnings || 0) > 0 ? "text-yellow-600" : "text-green-600"}`}>
                      {user.gameWarnings || 0}
                    </span>
                  </p>
                  <p>
                    Административные:{" "}
                    <span className={`font-medium ${(user.adminWarnings || 0) > 0 ? "text-red-600" : "text-green-600"}`}>
                      {user.adminWarnings || 0}
                    </span>
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                >
                  <Star className="text-yellow-500 mr-3 h-4 w-4" />
                  <span className="text-sm font-medium text-gray-700">Заявка на повышение</span>
                </Button>
                <Button
                  variant="secondary"
                  className="w-full justify-start p-3 h-auto text-left"
                >
                  <ArrowUpDown className="text-primary mr-3 h-4 w-4" />
                  <span className="text-sm font-medium text-gray-700">Запросить перевод</span>
                </Button>
                <Button
                  variant="secondary"
                  className="w-full justify-start p-3 h-auto text-left"
                >
                  <PlusIcon className="text-green-600 mr-3 h-4 w-4" />
                  <span className="text-sm font-medium text-gray-700">Оформить совмещение</span>
                </Button>
                <Button
                  variant="secondary"
                  className="w-full justify-start p-3 h-auto text-left"
                >
                  <Calendar className="text-gray-600 mr-3 h-4 w-4" />
                  <span className="text-sm font-medium text-gray-700">Взять отпуск</span>
                </Button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-700">Подать рапорт</span>
                </Button>
                <Button
                  variant="secondary"
                  className="w-full justify-start p-3 h-auto text-left"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700">Мои рапорты</span>
                </Button>
                <Button
                  variant="secondary"
                  className="w-full justify-start p-3 h-auto text-left"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700">Подать жалобу</span>
                </Button>
              </div>
            </div>
